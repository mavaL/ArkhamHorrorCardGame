...
{
	public class CreateSRIAWindow : BaseSRIAWindow<CreateSRIAWindow.Parameters>
	{
		public static bool IsOpen() { return Resources.FindObjectsOfTypeAll(typeof(CreateSRIAWindow)).Length > 0; }
