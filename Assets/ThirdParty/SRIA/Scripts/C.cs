...
namespace frame8.ScrollRectItemsAdapter
{
    ...
    {
		//public const double VERSION_FLOAT = 3.2;
		...
		public static string GetRandomTextBody(int minLen = 0, int maxLen = int.MaxValue) { return LOREM_IPSUM.Substring(0, Random.Range(minLen, Mathf.Min(maxLen, LOREM_IPSUM.Length))); }
